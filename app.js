...
{
	if (region.V.E === region.P.E)
	{
		return 'on line ' + region.V.E;
	}
	return 'on lines ' + region.V.E + ' through ' + region.P.E;
}
	...
	return _Utils_Tuple2(
		{
			...
			P: elm$time$Time$millisToPosix(1556391600000)
		},
		elm$core$Platform$Cmd$none);
};
var author$project$Main$CheckTime = function (a) {
	return {$: 1, a: a};
};
...
var elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {S: oldTime, ax: request, aD: subs};
	});
...
var author$project$Main$subscriptions = function (model) {
	return elm$browser$Browser$Events$onAnimationFrame(author$project$Main$CheckTime);
};
...
var author$project$Main$clockView = F3(
	function (hours, minute, second) {
...
var author$project$Main$dayView = function (days) {
	var label = function () {
		switch (days) {
			case 0:
				return ' jour';
...
var justinmimbs$date$Date$toCalendarDate = function (_n0) {
	...
	return A3(justinmimbs$date$Date$toCalendarDateHelp, date.aJ, 0, date.T);
};
var justinmimbs$date$Date$toMonths = function (rd) {
	var date = justinmimbs$date$Date$toCalendarDate(rd);
	var wholeMonths = (12 * (date.aJ - 1)) + (justinmimbs$date$Date$monthToNumber(date.am) - 1);
	return wholeMonths + (date.ab / 100);
};
...
var author$project$Main$view = function (model) {
	var countdown = model.K;
	var end = model.P;
	var sec = 59 - A2(elm$time$Time$toSecond, elm$time$Time$utc, countdown);
	var min = 60 - A2(elm$time$Time$toMinute, elm$time$Time$utc, countdown);
	var hours = A2(elm$time$Time$toHour, elm$time$Time$utc, end) - A2(elm$time$Time$toHour, elm$time$Time$utc, countdown);
	var days = A3(
		justinmimbs$date$Date$diff,
		3,
		A2(justinmimbs$date$Date$fromPosix, elm$time$Time$utc, countdown),
	...
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$dayView(days),
				A3(author$project$Main$clockView, hours, min, sec)
			]));
};
var elm$browser$Browser$element = _Browser_element;
var author$project$Main$main = elm$browser$Browser$element(
	{aT: author$project$Main$init, a_: author$project$Main$subscriptions, a0: author$project$Main$update, a2: author$project$Main$view});
